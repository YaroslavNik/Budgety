...
var UIController = (function() {
    ...
    return {
        getinput: function() {
            ...
            return {
                type: document.querySelector(DOMstrings.inputTipe).value,
...
var controller = (function(budgetCtrl, UICtrl) {
    ...
    var setupEventListener = function() {
        ...
        document.querySelector(DOM.inputTipe).addEventListener('change', UICtrl.changedType);
    };
    ...
    var ctrlDeleteItem = function(event) {
        ...
        if (itemID) {
            ...
            // 1.Delete the item from the data structuere
